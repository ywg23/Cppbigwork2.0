...
void syw1::showname()
{
    ...
    {
        case 9:{
        ui->name->setText(QString("历尽风雪的思念+%1").arg(level));
        break;
    }
    case 10:{
        ui->name->setText(QString("破冰踏雪的回音+%1").arg(level));
        break;
    }
    case 11:{
        ui->name->setText(QString("冰雪故园的终期+%1").arg(level));
        break;}
    case 12:{
        ui->name->setText(QString("摧冰而行的执望+%1").arg(level));
        break;}
    case 13:{
        ui->name->setText(QString("遍结寒霜的傲骨+%1").arg(level));
        break;}
    }
}

void syw1::showmainatt()
{
    if(kind==4)
    {
...
void syw1::showAttribute1(int a)
 {
     switch(a)
     {
...
void syw1::showAttribute2(int a)
 {
     switch(a)
     {
...
void syw1::showAttribute3(int a)
{
     switch(a)
     {
...
void syw1::showAttribute4(int a)
{
    if(isExist<=8)
        return;
     switch(a)
...
void syw1::on_twentyBtn_clicked()
{
    on_fourBtn_clicked();
    on_fourBtn_clicked();
    on_fourBtn_clicked();
...
void syw1::on_viewRatingBtn_clicked()
{
    ui->attribute1->hide();
    ui->attribute2->hide();
    ui->attribute3->hide();
    ...
    double mark=0;
    QString str;
    mark=sumatt[0]*0.389*0.75+sumatt[1]*1.33*0.75+sumatt[6]+sumatt[7]*2+sumatt[8]*1.1979*0.3;
    mark*=1.1;
